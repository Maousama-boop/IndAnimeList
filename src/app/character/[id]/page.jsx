...
const Page = async({params: {id}}) => {
    ...
    return (
        <>
            ...
            <Image src={animeCharacter.data.images.webp.image_url} alt={animeCharacter.data.images.jpg.image_url} height={250} width={250} className="object-cover rounded-md w-48 md:w-56 h-full"/>
